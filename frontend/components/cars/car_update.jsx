    ...
    return (
      <div className="create-car-container">
        <div className="create-car-banner">
          <h3 className="create-banner-text">Update your car</h3>
        </div>
        ...
        <form className="create-car-form" onSubmit={this.handleSubmit}>
          ...
          <label>
            ...
            <input
              ...
              onChange={this.handleInput("make")}
            />
          </label>
          ...
          <label>
            ...
            <input
              ...
              onChange={this.handleInput("doors")}
            />
          </label>
          ...
          <label>
            ...
            <input
              ...
              onChange={this.handleInput("plate")}
            />
          </label>
          ...
          <label>
            ...
            <input
              ...
              value="automatic"
              name="transmission"
              onChange={this.handleInput("transmission")}
            />
            Automatic
            <input
              type="radio"
